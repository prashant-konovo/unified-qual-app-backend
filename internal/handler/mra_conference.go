...
func (h *MRAHandler) AddConferenceLinkMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) UpdateConferenceLinkMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsConferenceRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{
			"error":        "conference repository not available",
			"errorMessage": "conference repository not available",
...
func (h *MRAHandler) GetConferenceLinkMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsConferenceRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{
			"error":        "conference repository not available",
			"errorMessage": "conference repository not available",
...
func (h *MRAHandler) GetConfLinkByTimeSlotMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsConferenceRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{
			"error":        "conference repository not available",
