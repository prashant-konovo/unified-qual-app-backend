...
func (h *MRAHandler) GetAllModeratorsMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsUserRepo == nil {
...
func (h *MRAHandler) PostModeratorAvailabilityMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) getAllModeratorAvailabilityWithImported(ctx context.Context, moderatorID, clientID int64) []map[string]any {
...
func (h *MRAHandler) UpdateModeratorAvailabilityMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) DeleteModeratorAvailabilityMRA(w http.ResponseWriter, r *http.Request) {
	idStr := chi.URLParam(r, "availability_id")
	avID, _ := strconv.ParseInt(idStr, 10, 64)
...
func (h *MRAHandler) GetModeratorsAvailabilityMRA(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (h *MRAHandler) GetModeratorTimeslotsMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) GetModeratorInterviewsMRA(w http.ResponseWriter, r *http.Request) {
	modIDStr := chi.URLParam(r, "moderator_id")
	modID, _ := strconv.ParseInt(modIDStr, 10, 64)
...
func (h *MRAHandler) GetProjectsForModeratorMRA(w http.ResponseWriter, r *http.Request) {
	modIDStr := chi.URLParam(r, "moderator_id")
	modID, _ := strconv.ParseInt(modIDStr, 10, 64)
	clientIDStr := chi.URLParam(r, "client_id")
	clientID, _ := strconv.ParseInt(clientIDStr, 10, 64)
...
func (h *MRAHandler) GetModeratorsListForProjectMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) UpdateModeratorMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) updateAvailabilitiesBasedOnBufferMRA(ctx context.Context, newBuffer int, moderatorID, clientID int64, increase bool) error {
...
// based on proximity to scheduled interviews after a buffer change.
func (h *MRAHandler) updateImportedAvailabilitiesBasedOnBufferMRA(ctx context.Context, newBuffer int, moderatorID, clientID int64, increase bool) error {
	interviews, err := h.qsUserRepo.GetFutureModeratorTimeslotsMRA(ctx, moderatorID, clientID)
	if err != nil {
		return fmt.Errorf("get future timeslots: %w", err)
	}
...
func (h *MRAHandler) processAvailabilityBufferAdjustmentMRA(ctx context.Context,
...
func (h *MRAHandler) GetModeratorsForTimeSlotMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) GetModeratorsOptionMRA(w http.ResponseWriter, r *http.Request) {
	tsIDStr := chi.URLParam(r, "timeslot_id")
	tsID, _ := strconv.ParseInt(tsIDStr, 10, 64)
...
func (h *MRAHandler) GetParticipantIdMRA(w http.ResponseWriter, r *http.Request) {
	tsIDStr := chi.URLParam(r, "timeslot_id")
	tsID, _ := strconv.ParseInt(tsIDStr, 10, 64)
...
func (h *MRAHandler) UpsertModeratorTimeRangeMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) GetModeratorAvailabilityByClientMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsUserRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{
...
func (h *MRAHandler) StartModeratorImportMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsUserRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{"error": "repository not available"})
		return
	}
...
func (h *MRAHandler) GetImportedAvailabilityFromCurrentSyncMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsUserRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{"error": "repository not available"})
		return
	}
...
func (h *MRAHandler) GetImportStatusMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsUserRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{"error": "repository not available"})
		return
	}
...
func (h *MRAHandler) UnlinkImportedModeratorMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsUserRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{"error": "repository not available"})
		return
	}
...
func (h *MRAHandler) UpdateGoogleSheetFirstDateMRA(w http.ResponseWriter, r *http.Request) {
