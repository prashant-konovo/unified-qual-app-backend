...
func (h *LSHandler) CreatePaymentReal(w http.ResponseWriter, r *http.Request) {
	var req struct {
...
func (h *LSHandler) CreateCustomHonorariumReal(w http.ResponseWriter, r *http.Request) {
	var req struct {
		TimeSlotID int64  `json:"timeSlotId"`
		Amount     int    `json:"amount"`
...
func (h *LSHandler) GetPaymentStatusListReal(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) CreateExternalPayment(w http.ResponseWriter, r *http.Request) {
	var req struct {
		TimeSlotID  int64  `json:"timeSlotId"`
		Amount      int    `json:"amount"`
		PaymentType string `json:"paymentType"`
...
func (h *LSHandler) GetHonorariumReasons(w http.ResponseWriter, r *http.Request) {
	if h.qsAnswerRepo != nil {
...
func (h *LSHandler) GetInterviewPaymentStatusList(w http.ResponseWriter, r *http.Request) {
	if h.qsAnswerRepo != nil {
