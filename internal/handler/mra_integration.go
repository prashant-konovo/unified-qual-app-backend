...
func (h *MRAHandler) ThirdPartyIntegrateMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) LogFrontEndEventMRA(w http.ResponseWriter, r *http.Request) {
	var body struct {
...
func (h *MRAHandler) QualEligibilityMRA(w http.ResponseWriter, r *http.Request) {
