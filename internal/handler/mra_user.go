...
func (h *MRAHandler) PatchUser(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) PatchUserFromProfile(w http.ResponseWriter, r *http.Request) {
	userID, err := validate.ParseIDParam(r, "user_id")
	if err != nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{
			"error":        err.Error(),
...
func (h *MRAHandler) CheckPasswordMatchesMRA(w http.ResponseWriter, r *http.Request) {
