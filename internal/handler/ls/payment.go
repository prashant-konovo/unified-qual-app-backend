...
func (h *Handler) CreatePaymentReal(w http.ResponseWriter, r *http.Request) {
	...
	if h.QsAnswerRepo != nil {
		...
		core.WriteJSON(w, http.StatusCreated, map[string]any{"id": id, "timeSlotId": req.TimeSlotID})
		return
	}
...
func (h *Handler) GetPaymentStatusListReal(w http.ResponseWriter, r *http.Request) {
	...
	core.WriteJSON(w, http.StatusOK, statuses)
}
...
func (h *Handler) CreateExternalPayment(w http.ResponseWriter, r *http.Request) {
	...
	if h.QsAnswerRepo != nil {
		...
		core.WriteJSON(w, http.StatusCreated, map[string]any{"id": payID, "timeSlotId": req.TimeSlotID, "external": true})
		return
	}
	core.WriteJSON(w, http.StatusServiceUnavailable, map[string]any{"error": "no database available"})
}
...
func (h *Handler) GetHonorariumReasons(w http.ResponseWriter, r *http.Request) {
	if h.QsAnswerRepo != nil {
		...
		core.WriteJSON(w, http.StatusOK, reasons)
		return
	}
