...
func (h *LSHandler) ListSubscriptions(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
...
func (h *LSHandler) CreateSubscription(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, http.StatusCreated, map[string]any{"message": "subscription creation not yet implemented"})
}

func (h *LSHandler) GetSubscription(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) UpdateSubscription(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, http.StatusOK, map[string]any{"message": "subscription update not yet implemented"})
}

func (h *LSHandler) DeleteSubscription(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) GetSubscriptionInterviews(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) GetSubscriptionCrowds(w http.ResponseWriter, r *http.Request) {
	subID, err := validate.ParseIDParam(r, "id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *LSHandler) buildCrowdBasicJSON(ctx context.Context, c iris.ICCrowd) map[string]any {
	// Type description
	typeDesc := ""
...
func (h *LSHandler) GetSubscriptionQuestionTypes(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) GetSubscriptionInquiries(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) GetSubscriptionProjectInquiry(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) GetSubscriptionProjectSurveys(w http.ResponseWriter, r *http.Request) {
	subID, err := validate.ParseIDParam(r, "subId")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *LSHandler) UpdateInquiryPreview(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) assessCrowdDifficulty(ctx context.Context, crowd *ipCrowdSpec, assessments []iris.DifficultyAssessmentRow) *ipDifficultyAssessmentResp {
	const (
		responseRate   = 0.2
		acceptanceRate = 0.6
		schedulingRate = 0.8
...
func (h *LSHandler) CreateCustomCrowdInquiry(w http.ResponseWriter, r *http.Request) {
