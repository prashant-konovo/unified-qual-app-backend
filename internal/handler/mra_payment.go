...
func (h *MRAHandler) AddHonorariumAmountMRA(w http.ResponseWriter, r *http.Request) {
	var body struct {
...
func (h *MRAHandler) GetHonoValueUpdateReasonListMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) AddTimeSlotPaymentsMRA(w http.ResponseWriter, r *http.Request) {
	var body struct {
...
func (h *MRAHandler) processPendingPaymentsForTimeslotIdsMRA(ctx context.Context, payments []map[string]any) {
...
func (h *MRAHandler) AddExternalTimeSlotPaymentsMRA(w http.ResponseWriter, r *http.Request) {
	var body []struct {
...
func (h *MRAHandler) AddTimeSlotCustomHonorariumMRA(w http.ResponseWriter, r *http.Request) {
	var body struct {
...
func (h *MRAHandler) callStepFunctionForCustomHonoMRA(ctx context.Context, timeSlotID int64, oldValue, newValue float64, reasonCode string, userID int64) {
...
func (h *MRAHandler) GetInterviewPaymentStatusListMRA(w http.ResponseWriter, r *http.Request) {
