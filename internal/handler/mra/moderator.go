...
func (h *Handler) GetAllModeratorsMRA(w http.ResponseWriter, r *http.Request) {
	if h.QsUserRepo == nil {
		core.WriteJSON(w, http.StatusInternalServerError, map[string]any{"error": "user repository not available"})
		return
	}
	...
	core.WriteJSON(w, http.StatusOK, records)
}
...
func (h *Handler) PostModeratorAvailabilityMRA(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil || errEnd != nil {
		core.WriteJSON(w, http.StatusBadRequest, map[string]any{"error": "Invalid date format"})
		return
	}
	...
	if calStatus == "In Progress" {
		core.WriteJSON(w, http.StatusMethodNotAllowed, map[string]any{
...
func (h *Handler) UpdateModeratorAvailabilityMRA(w http.ResponseWriter, r *http.Request) {
	...
	if oldAv == nil {
		core.WriteJSON(w, http.StatusNotFound, map[string]any{"error": "Availability not found"})
		return
	}
...
func (h *Handler) GetModeratorsAvailabilityMRA(w http.ResponseWriter, r *http.Request) {
	...
	core.WriteJSON(w, http.StatusOK, grouped)
}
...
func (h *Handler) StartModeratorImportMRA(w http.ResponseWriter, r *http.Request) {
	...
	core.WriteJSON(w, http.StatusOK, "Importing in progress")
}
...
func (h *Handler) UpdateGoogleSheetFirstDateMRA(w http.ResponseWriter, r *http.Request) {
	...
	core.WriteJSON(w, http.StatusOK, map[string]any{"fileURL": ""})
}
