...
func (h *LSHandler) GetSurveyDetail(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) ValidateSurvey(w http.ResponseWriter, r *http.Request) {
	surveyID, err := validate.ParseIDParam(r, "id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *LSHandler) GetSurveyCrowds(w http.ResponseWriter, r *http.Request) {
	surveyID, err := validate.ParseIDParam(r, "id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *LSHandler) buildSurveyCrowdFlatJSON(ctx context.Context, sc iris.ICSurveyCrowd) map[string]any {
...
func (h *LSHandler) buildSurveyCrowdAdminJSON(ctx context.Context, sc iris.ICSurveyCrowd, survey *iris.ICSurvey) map[string]any {
...
func (h *LSHandler) buildSurveyCrowdSharedJSON(ctx context.Context, sc iris.ICSurveyCrowd) map[string]any {
	flat := h.buildSurveyCrowdFlatJSON(ctx, sc)
...
func (h *LSHandler) buildSurveyCrowdHonoJSON(ctx context.Context, sc iris.ICSurveyCrowd, survey *iris.ICSurvey) map[string]any {
...
func (h *LSHandler) buildSurveyCrowdSubscriberJSON(ctx context.Context, sc iris.ICSurveyCrowd, survey *iris.ICSurvey) map[string]any {
	shared := h.buildSurveyCrowdSharedJSON(ctx, sc)
...
func (h *LSHandler) buildSurveyCrowdMinimalJSON(ctx context.Context, sc iris.ICSurveyCrowd, survey *iris.ICSurvey) map[string]any {
	shared := h.buildSurveyCrowdSharedJSON(ctx, sc)
...
func (h *LSHandler) buildSurveyCrowdDetailJSON(ctx context.Context, sc iris.ICSurveyCrowd, survey *iris.ICSurvey) map[string]any {
	flat := h.buildSurveyCrowdFlatJSON(ctx, sc)
...
func (h *LSHandler) buildCrowdBasicJSONForSurveyCrowd(ctx context.Context, crowdID int64) map[string]any {
...
func (h *LSHandler) buildCrowdFlatJSON(ctx context.Context, crowdID int64, surveyID *int64) map[string]any {
...
func (h *LSHandler) buildCrowdFlatICJSON(ctx context.Context, crowdID int64) map[string]any {
	base := h.buildCrowdBasicJSONForSurveyCrowd(ctx, crowdID)
	size := h.irisSurveyRepo.GetCrowdSize(ctx, crowdID)
...
func (h *LSHandler) buildCrowdAdminJSONAvailable(ctx context.Context, crowdID, surveyID int64) map[string]any {
...
func (h *LSHandler) CloseSurvey(w http.ResponseWriter, r *http.Request) {
	surveyID, err := validate.ParseIDParam(r, "id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *LSHandler) ToggleSurveyFavorite(w http.ResponseWriter, r *http.Request) {
	surveyID, err := validate.ParseIDParam(r, "id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *LSHandler) buildSubscriberJSON(r *http.Request, s *iris.ICSurvey, callerUserID int64) map[string]any {
	ctx := r.Context()
