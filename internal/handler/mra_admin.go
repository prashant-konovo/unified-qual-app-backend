...
func (h *MRAHandler) ListAdminUsersMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsUserRepo == nil {
...
func (h *MRAHandler) GetAllProjectManagersMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsUserRepo == nil {
...
func (h *MRAHandler) GetPMTimeslotsMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) GetAvailabilitiesForPMMRA(w http.ResponseWriter, r *http.Request) {
	clientIDStr := chi.URLParam(r, "client_id")
	clientID, _ := strconv.ParseInt(clientIDStr, 10, 64)
