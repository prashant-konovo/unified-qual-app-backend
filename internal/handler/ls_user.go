...
func (h *LSHandler) SendPasswordResetEmail(w http.ResponseWriter, r *http.Request) {
	var req struct {
...
func (h *LSHandler) CheckUserIsQsToolAndI2(w http.ResponseWriter, r *http.Request) {
	var req struct {
...
func (h *LSHandler) CheckUserCommPreference(w http.ResponseWriter, r *http.Request) {
...
func (h *LSHandler) UnsubscribeUser(w http.ResponseWriter, r *http.Request) {
