...
func (h *MRAHandler) CreateProjectMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) GetProjectMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) ListProjectsMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) UpdateProjectMRA(w http.ResponseWriter, r *http.Request) {
...
func (h *MRAHandler) UpdateExternalSurveyIDMRA(w http.ResponseWriter, r *http.Request) {
	projectID, err := validate.ParseIDParam(r, "project_id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *MRAHandler) ResetProjectModeratorsMRA(w http.ResponseWriter, r *http.Request) {
	projectID, err := validate.ParseIDParam(r, "project_id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *MRAHandler) GetEmailTemplateMRA(w http.ResponseWriter, r *http.Request) {
	if h.qsProjectRepo == nil {
		writeJSON(w, http.StatusInternalServerError, map[string]any{
			"error":        "database not configured",
...
func (h *MRAHandler) HandleProjectExportMRA(w http.ResponseWriter, r *http.Request) {
	projectID, err := validate.ParseIDParam(r, "project_id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *MRAHandler) UpdateSampleSizeMRA(w http.ResponseWriter, r *http.Request) {
	projectID, err := validate.ParseIDParam(r, "project_id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *MRAHandler) GetUnavailableModeratorsMRA(w http.ResponseWriter, r *http.Request) {
	projectID, err := validate.ParseIDParam(r, "project_id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
...
func (h *MRAHandler) GetModeratorsCountMRA(w http.ResponseWriter, r *http.Request) {
	projectID, err := validate.ParseIDParam(r, "project_id")
	if err != nil {
		writeJSON(w, http.StatusBadRequest, map[string]any{"error": err.Error()})
		return
